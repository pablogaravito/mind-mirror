    ...
    <div style={{
      ...
      <div style={{ width: "100%", maxWidth: "420px" }}>
        ...
        <div className="text-center" style={{ marginBottom: "2.5rem" }}>
          ...
          <p>Evaluaciones psicológicas basadas en investigación científica.</p>
        </div>
        ...
        <div className="card">
          {sent ? (
            <div className="text-center">
              ...
              <p className="mt-2">
                Te enviamos un enlace a <strong>{email}</strong>. Haz clic en él para ingresar.
              </p>
              <button className="btn btn--ghost mt-3" onClick={() => setSent(false)}>
                Usar otro correo
              </button>
            </div>
          ) : (
            <>
              <button className="btn btn--outline btn--full" onClick={handleGoogle}>
                <GoogleIcon />
        ...
        <p className="text-center text-muted mt-3" style={{ fontSize: "0.8rem" }}>
          Al ingresar aceptas el uso de tus datos para fines de evaluación psicológica.
        </p>
      </div>
    </div>
  );
